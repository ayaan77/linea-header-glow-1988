        ...
        <ContentSection title="Contact Information">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">care@sifarjewelry.com</p>
        ...
        <ContentSection title="Frequently Asked Questions">
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="warranty" className="border border-border rounded-lg px-6">
              ...
              <AccordionContent className="text-muted-foreground">
                All SIFAR jewelry comes with a lifetime warranty against manufacturing defects. This includes free repairs for normal wear and tear, stone tightening, and professional cleaning.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="care" className="border border-border rounded-lg px-6">
              <AccordionTrigger className="text-left hover:no-underline">
                How should I care for my SIFAR jewelry?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground">
            ...
            <AccordionItem value="authentication" className="border border-border rounded-lg px-6">
              ...
              <AccordionContent className="text-muted-foreground">
                Every SIFAR piece comes with a certificate of authenticity and is hallmarked. You can verify authenticity on our website using your unique piece number or contact our customer care team.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </ContentSection>
